...
<div class="doc page-layout simple full-width">
    ...
    <!-- HEADER -->
    <div class="page-header bg-primary text-auto p-6"><h2 class="doc-title" id="content">Importowanie przelewów przychodzących</h2>
    </div>
    <!-- / HEADER -->
            ...
            <form id="nowyPojazd" name="nowyPojazd" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                ...
                <div class="profile-box info-box general card mb-4">
                    ...
                    <header class="h6 bg-primary text-auto p-4">
                        <div class="title">Importowanie  przelewów przychodzących</div>
                    </header>
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                    <label for="inputSkan" class="col-form-label">Importuj plik XLSX</label>
...
<script>
    $(document).ready(function () {
        ...
        $('#nowyPojazd').formValidation({
            ...
            e.preventDefault();
            $.ajax({
                url: '<?PHP echo base_url(); ?>Przelewy/Import_przychodow_ajax',
                type: "POST",
                data: formData,
