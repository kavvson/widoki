        ...
        table = $('#table').DataTable({
            ...
            "ajax": {
                ...
                "dataSrc": function (json) {
                    $("#curr_netto").html("Zus pracownik : " + addCommas(Math.round(json.agregacja.zus_pracownik)) + " zł");
                    $("#curr_vat").html("Zus pracodawca : " + addCommas(Math.round(json.agregacja.zus_pracodawca)) + " zł");
                    $("#curr_vat2").html("Zus łącznie : " + addCommas(Math.round(json.agregacja.zus_lacznie)) + " zł");
                    $("#curr_brutto").html("Brutto : " + addCommas(Math.round(json.agregacja.brutto)) + " zł");
                    $("#pozostala_kwota").html("Do wypłaty : " + addCommas(Math.round(json.agregacja.do_wyplaty)) + " zł");
