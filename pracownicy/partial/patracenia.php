        ...
        <div class="col-12 col-md-12">
            ...
            <div class="profile-box info-box general card mb-4">
                ...
                <header class="h6 row no-gutters align-items-center justify-content-between bg-primary text-auto p-4">
                    <div class="title">Informacje o potrąceniach</div>

                    <button type="button"  data-toggle="modal"
                            data-target="#dodajPotracenie" href="#" class="btn btn-secondary"><i
                                class="icon-add"></i> Dodaj potrącenie
                    </button>
                </header>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        table = $('#table').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('Place/patracenia_list') ?>",
                "type": "POST",
                "data": function (data) {
