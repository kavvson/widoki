<div class="doc page-layout simple full-width">
    ...
    <!-- HEADER -->
    <div class="page-header bg-primary text-auto p-6"><h2 class="doc-title" id="content">Dodawanie kontraktu</h2>
    </div>
    <!-- / HEADER -->
        ...
        <div class="col-12 col-md-12">
            ...
            <div class="profile-box info-box contact card mb-4">
                ...
                <header class="h6 bg-primary text-auto p-4">
                    <div class="title">Dodawanie kontraktu</div>
                </header>

                <div class="content p-4">
                    <?php echo form_open('kontrakt/add', array("class" => "form-horizontal")); ?>
                                ...
                                <div class="col-sm-7">
                                    <div class="form-check form-check">
                                        <label class="form-check-label">
                                            <input class="form-check-input" type="radio" name="zakonczony" value="0"  checked="checked">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                            <input class="form-check-input" type="radio" name="zakonczony" id="inlineRadio3" value="1">
                                            <span class="radio-icon fuse-ripple-ready"></span>
