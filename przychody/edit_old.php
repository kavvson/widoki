...
<div class="doc page-layout simple full-width">
    ...
    <!-- HEADER -->
    <div class="page-header bg-primary text-auto p-6"><h2 class="doc-title" id="content">Modyfikacja faktury <?PHP echo $faktura->numer; ?></h2>
    </div>
    <!-- / HEADER -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-header bg-green-400 text-white">
                    ...
                    <div class="row col-lg-12">
                        <div class="col-md-8"><h4 class="modal-title" id="myLargeModalLabel">Modyfikacja faktury <?PHP echo $faktura->numer; ?></h4></div>
                        ...
                        <form id="edycjaFaktury" name="nowyPracownik" method="post">
                                ...
                                <div class="tab-content">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <input type="text" name="inputDatawystaw" id="inputDatawystaw" class="form-control" value="<?PHP echo $faktura->z_dnia; ?>"/>
                                                        </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <input type="text" name="inputDatasprze" id="inputDatasprze" class="form-control" value="<?PHP echo $faktura->sprzedano; ?>"/>
                                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="dodatkowe-onfo-pane" role="tabpanel" aria-labelledby="dodatkowe-onfo" aria-expanded="false">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12">
                                                <textarea id="inputOpis" name="inputOpis" style="height:100px;" class="form-control"><?PHP echo $faktura->uwagi; ?></textarea>
                                            </div>
                                ...
                                <table style="border-collapse:collapse;width:100%;" id="faktura_t" class="table table-bordered">
                                    ...
                                    <tbody>
                                        <?PHP foreach ($wpisy as $w) { ?>
                                            <tr><td></td>
                                                <td><input type="text" value="<?PHP echo $w->nazwa; ?>" name="data[InvoiceContent][<?PHP echo $w->id_item; ?>][name]" class="form-control"></td>
                            ...
                            <div class="form-group">
                                <div class="col-xs-5 col-xs-offset-3">
                                    <button type="submit" class="btn btn-primary fuse-ripple-ready">Edytuj fakturę</button>
...
$(document).ready(function() {
    $("#newrow").on("click", function() {
        ...
        $("#faktura_t").find('input[name^="p_cnetto"]').inputmask({
            alias: "currency",
            prefix: "Zł "
        });
        $("#faktura_t").find('input[name^="p_ilosc"]').inputmask({
            alias: "currency",
            prefix: ""
        })
    });
    ...
    $('#edycjaFaktury').formValidation({
        ...
        e.preventDefault();
        $.ajax({
            url: '<?PHP echo base_url(); ?>Przychody/edytuj_fakture/<?PHP echo $faktura->id_przychodu; ?>',
            method: 'POST',
    ...
    $('#dodawanie_faktury').on('shown.bs.modal', function() {
        $('#edycjaFaktury').data('formValidation').resetForm();
        $('#edycjaFaktury').trigger("reset");
