...
<div class="wrapper">
    ...
    <h3 class="hf">Potwierdzenie opłacenia wydatku</h3>
    <table style="border-collapse:collapse;width:100%;" class="">
        ...
        foreach($dane as $p){
            $jeszcze_do_zaplaty += $p['pozostala_kwota'];
            echo '<tr>
            <td class="la" style="border-color: rgb(0, 0, 0); border-width: 1px; border-style: solid;width: 45%;">'.$p['numer'].'</td>
            <td style="border-color: rgb(0, 0, 0); border-width: 1px; border-style: solid;">'.pp($p['wartosc']).'</td>
            <td class="text-right" style="border-color: rgb(0, 0, 0); border-width: 1px; border-style: solid;">'.pp($p['zaplacona_kwota']).'</td>
            <td class="text-center" style="border-color: rgb(0, 0, 0); border-width: 1px; border-style: solid;">'.pp($p['pozostala_kwota']).'</td>
        </tr>';
        }?>
    ...
    <table style="border-collapse:collapse;width:50%; float: right;" cellpadding="0" align="right">
        ...
        <tr class="hclass">
            <td></td>
            <td colspan="2"><b>Pozostałe zobowiązania : PLN <?PHP echo $jeszcze_do_zaplaty; ?></b></td>
            <td></td>
        </tr>
        <tr>
            <td></td>
