...
<div class="wrapper">
    <table style="text-align: left; border-collapse: collapse; width: 100%;" cellpadding="0">
        ...
        <tr>
            ...
            <td style="border-color: rgb(0, 0, 0);"></td>
            <td class="hclass">Data wypłaty</td>
        </tr>
        <tr>
            <td style="border-color: rgb(0, 0, 0);">KRS: 0000622022</td>
            <td style="border-color: rgb(0, 0, 0);"></td>
            <td class="bbottom"><?PHP echo $wypl["zarejestrowano"]; ?></td>
        </tr>
        <tr>
    ...
    <table style="border-collapse:collapse;width:100%;">
        ...
        <tr>
            ...
            <td></td>
            <td><?PHP echo $wypl["kupujacy"]; ?></td>
        </tr>
        <tr>
            <td>REGON: 364654900</td>
            <td></td>
            <td><?PHP echo $wypl['ulica']; ?></td>
        </tr>
        <tr>
            <td>Szczawińska 2a, 95-100 Zgierz</td>
            <td></td>
            <td><?PHP echo $wypl['kod_pocztowy']; ?> <?PHP echo $wypl['miasto']; ?></td>
        </tr>
        <tr>
    ...
    <h3 class="hf">Wypłata</h3>
    <table style="border-collapse:collapse;width:100%;" class="">
        <tbody>
        <tr class="hclass addborder right">
        ...
        <tr>
            <td class="la" style="border-color: rgb(0, 0, 0); border-width: 1px; border-style: solid;width: 45%;">Wypłata</td>
            <td class="text-center" style="border-color: rgb(0, 0, 0); border-width: 1px; border-style: solid;"><?PHP echo $wypl["kwota"]; ?></td>
        </tr>
    ...
    <table style="border-collapse:collapse;width:50%; float: right;" cellpadding="0" align="right">
        ...
        <tr class="hclass">
            <td></td>
            <td colspan="2"><b>Razem do wypłaty: PLN <?PHP echo $wypl['kwota']; ?></b></td>
            <td></td>
        </tr>
        <tr>
            <td></td>
            <td width="110px;" class="pull-right">Słownie :</td>
            <td class=""><?PHP say($wypl['kwota']); ?> PLN<br/>
            </td>
        </tr>
        </tbody>
    </table>
...
<b>Opis</b>: <?PHP echo $wypl['opis']; ?><br>
<div class="footer">
    <table style="border-collapse:collapse;width:100%;">
        <tbody>
        <tr>
        ...
        <tr>
            <td class="text-center">Podpis osoby upoważnionej do wystawienia wypłaty</td>
            <td class="">&nbsp;</td>
            <td class="text-center">Podpis osoby upoważnionej do odbioru wypłaty</td>
        </tr>
        </tbody>
    </table>
</div>